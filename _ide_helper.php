...
namespace Flugg\Responder\Facades { 
    ...
    class Transformer {
         ...
         * @static 
         */ 
        public static function transform($data = null, $transformer = null, $with = array(), $without = array())
        {
            return \Flugg\Responder\Transformer::transform($data, $transformer, $with, $without);
        }
...
namespace  { 
    ...
    class Transformer extends \Flugg\Responder\Facades\Transformer {}
